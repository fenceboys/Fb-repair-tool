        ...
        {quote.internal_notes && (
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Internal Notes</h2>
            </div>
            <p className="text-gray-900 whitespace-pre-wrap">{quote.internal_notes}</p>
          </div>
        )}
